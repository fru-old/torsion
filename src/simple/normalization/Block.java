...
public class Block extends Operation{
	...
	public Block(int location, boolean forward){
		this(location, forward, new ArrayList<Operation>());
	}
	
	public Block(int location, boolean forward, List<Operation> body){
		super(location);
		this.body = body;
	...
	public static void applyBlocks(List<Operation> list){
		applySimpleBackwardBlocks(list);
		findForwardBlocks(list,list, new HashSet<Integer>());
	}
	
	private static void findForwardBlocks(List<Operation> list,List<Operation> top, HashSet<Integer> complete){
	...
	private static FoundStatus applyForwardBlocks(List<Operation> list, int label , boolean jumpIsAbove){
	...
	private static Block createBlock(List<Operation> parent, int start, int end, int location, boolean forward){
	...
	private static void setJumpBlock(List<Operation> list, int location, Block block, boolean forward){
		for(Operation o : list){
	...
	private static void applySimpleBackwardBlocks(List<Operation> list){
	...
	private static boolean isCorrectJump(Operation o, boolean forward){
