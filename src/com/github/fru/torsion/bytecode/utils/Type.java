...
public class Type {
	...
	public static final Type REFERENCE_TYPE = new Type("L");
	...
	private static final Type[] typeOrder = {INTEGER_TYPE, LONG_TYPE, FLOAT_TYPE, DOUBLE_TYPE, REFERENCE_TYPE, BYTE_TYPE, CHAR_TYPE, SHORT_TYPE};
	...
	public static Type getConstantType(int index, Map<Integer, ClassFileConstant> constants){
		...
		if(constant.getType() == ClassFileConstantType.String)return Type.REFERENCE_TYPE;
