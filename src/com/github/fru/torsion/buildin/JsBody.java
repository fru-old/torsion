...
public class JsBody {
	...
	public static void printBody(PrintWriter out, Body body, AccessibleObject accessible){
	...
	public static void simpleInstruction(PrintWriter out, Instruction i, AccessibleObject accessible){
